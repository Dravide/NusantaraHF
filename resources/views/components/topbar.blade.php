            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#" role="button"
                   aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('')}}nara/images/flags/us_flag.jpg" alt="" class="thumb-xxs rounded">
                </a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="#"><img src="{{ asset('')}}nara/images/flags/us_flag.jpg" alt=""
                                                           height="15" class="me-2">English</a>
                    <a class="dropdown-item" href="#"><img src="{{ asset('')}}nara/images/flags/spain_flag.jpg" alt=""
                                                           height="15" class="me-2">Spanish</a>
                    <a class="dropdown-item" href="#"><img src="{{ asset('')}}nara/images/flags/germany_flag.jpg" alt=""
                                                           height="15" class="me-2">German</a>
                    <a class="dropdown-item" href="#"><img src="{{ asset('')}}nara/images/flags/french_flag.jpg" alt=""
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                    ...
                    <div class="notification-menu" data-simplebar>
                        ...
                        <a href="#" class="dropdown-item py-3">
                            ...
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{ asset('')}}nara/images/users/user-1.jpg" alt=""
                        ...
                        <a href="#" class="dropdown-item py-3">
                            ...
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{ asset('')}}nara/images/users/user-4.jpg" alt=""
                                         class="thumb-sm rounded-circle">
                                </div>
                                <div class="media-body align-self-center ms-2 text-truncate">
                        ...
                        <a href="#" class="dropdown-item py-3">
                            ...
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{ asset('')}}nara/images/users/user-2.jpg" alt=""
                                         class="thumb-sm rounded-circle">
                                </div>
                                <div class="media-body align-self-center ms-2 text-truncate">
                        ...
                        <a href="#" class="dropdown-item py-3">
                            ...
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{ asset('')}}nara/images/users/user-5.jpg" alt=""
                                         class="thumb-sm rounded-circle">
                                </div>
                                <div class="media-body align-self-center ms-2 text-truncate">
                                    <h6 class="my-0 fw-normal text-dark">Your order is placed</h6>
                        ...
                        <a href="#" class="dropdown-item py-3">
                            ...
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{ asset('')}}nara/images/users/user-3.jpg" alt=""
                                         class="thumb-sm rounded-circle">
                                </div>
                                <div class="media-body align-self-center ms-2 text-truncate">
                ...
                <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
                   aria-haspopup="false" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('')}}nara/images/users/user-4.jpg" alt="profile-user"
